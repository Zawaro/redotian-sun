# cell-util Specification

## Purpose

CellUtil provides the canonical 2 m grid coordinate conversions and cell identity helpers: world-to-cell and cell-to-world mappings, cell-origin conversions, integer and string cell keys, the A* heuristic, spiral placement, footprint helpers, and the diamond containment check.
