...
Resolve player-issued orders and cursors from the current selection: the `OrderResult` data
class, the per-component order-targeter interface, `OrderResolver`, and the order generators
(unit, sell, repair).
## Requirements
